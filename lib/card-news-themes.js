...
const themes = {
  charcoal: {
    name: '차콜 & 골드',
    primary: '#2A2A2A',       // 프리미엄 튜닝: 더 깊은 차콜 (3A → 2A)
    secondary: '#F5F4F0',
    accent: '#D4B87A',        // 프리미엄 튜닝: 더 밝은 골드 (C8A96E → D4B87A, 다크 대비 ↑)
    text: '#1F1F1F',          // 본문 더 선명 (2A → 1F)
    textLight: '#8A8680',
    bg: '#FAF9F7',
    bgDark: '#141414',        // near-black 딥 프리미엄 (1E → 14)
    radius: 10,               // 14 → 10 (각진 프리미엄)
  },
  midnight: {
    name: '미드나잇 블루',
    primary: '#1E3A5F',
  ...
  lavender: {
    name: '라벤더',
    primary: '#B09FC7',       // 연한 라벤더 (부드러움)
    secondary: '#F2EDF7',
    accent: '#D4A574',        // 깊은 웜 골드 (대비 ↑)
    text: '#2A2438',
    textLight: '#6B6378',
    bg: '#FBF9FD',            // 베이스도 더 연하게
    bgDark: '#4A3F5E',        // 딥 라벤더
    radius: 14,
  },
};

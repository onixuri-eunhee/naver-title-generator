...
import { PRESETS as REMOTION_PRESETS } from '@/remotion/shortform/presets.js';
...
/**
 * PresetPicker 카드 썸네일용 — colorPreset별 배경/액센트 색.
 * remotion/shortform/presets.js(단일 진실원천)에서 파생 — 수동 중복 정의 금지.
 */
export const COLOR_PRESET_SWATCHES = Object.fromEntries(
  Object.entries(REMOTION_PRESETS).map(([id, preset]) => [
    id,
    {
      bg: preset.colors.bgBase,
      accent: preset.colors.accent,
      text: preset.colors.textPrimary,
    },
  ]),
);

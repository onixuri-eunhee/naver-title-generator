...
// 원고 = Sonnet, 검수 = Haiku(저비용).
// 2026-07-08: claude-sonnet-4-20250514는 삭제(404) 확인 → sonnet-5로 교체.
 ...
 */
// temperature 기본 null: DRAFT_MODEL(sonnet-5)은 temperature를 보내면 400이라 기본은 생략.
// 값이 필요한 호출(예: Haiku 검수)은 명시적으로 넘긴다.
export async function callClaude({ system, messages, model = DRAFT_MODEL, maxTokens = 4096, temperature = null }) {

 ...
 *
 * NOTE: DEFAULT_DESIGN_TOKENS는 design-tokens-shared.js에서 re-export.
 * 클라이언트/Remotion 번들에서는 design-tokens-shared.js를 직접 import할 것.
 */
import { getRedis } from '@/lib/api-helpers';
export { DEFAULT_DESIGN_TOKENS } from './design-tokens-shared.js';
import { DEFAULT_DESIGN_TOKENS } from './design-tokens-shared.js';

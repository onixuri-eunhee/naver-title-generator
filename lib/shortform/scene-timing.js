...
//   1차 15f은 부족해 25f(833ms)로 증가. 씬 전환 시 누적 lag 해소.
// - TAIL_PADDING_FRAMES: 마지막 씬 duration에 추가. ElevenLabs char end는 발화 끝이라
//   잔향/숨 포즈 포함 X — CTA 잘림 방지. 1차 20f 여전히 CTA 잘림 관찰 → 45f(1.5s)로 증가.
export const AUDIO_PREROLL_FRAMES = 25;     // 833ms @ 30fps
export const TAIL_PADDING_FRAMES = 45;      // 1.5s @ 30fps
...
// Phase 2 (2026-04-18): wipe/flip 제거 — 복잡 레이아웃 tear 방지 (SceneSequenceComposition과 동기화 필수).

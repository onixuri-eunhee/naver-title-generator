...
[캡션 하드 룰]
- 인스타와 유튜브는 본문 문구가 달라야 함 (같은 문장 복붙 금지).
- 인스타: "더보기" 전 125자 안에 scroll-stop 후킹. CTA는 "저장해두세요" 같은 인스타 관습. 링크 불가.
- 유튜브: 반드시 #Shorts 해시태그 포함 (피드 편입 조건). CTA는 "구독 부탁드려요" 같은 유튜브 관습.
- 두 캡션 모두 1인칭 존댓말, 이모지 금지, 해시태그는 한글/영문 모두 허용.

...
const layouts = {
  ...
  summary: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: 60 } },
    ...
    h('div', { style: { display: 'flex', flexDirection: 'column', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72, borderLeft: `8px solid ${t.accent}` } },
      ...
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 56, color: '#1A1A1A', lineHeight: 1.4, marginBottom: 40 } }, s.title || ''),
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 400, fontSize: 40, color: '#444444', lineHeight: 1.75 } }, s.body || ''),
    ),
  ),
  content: (s, t) => { const num = s.number ? String(s.number).padStart(2, '0') : '01'; return h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.secondary, padding: 60 } },
    ...
    h('div', { style: { display: 'flex', flexDirection: 'column', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      ...
      // 제목
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 52, color: '#1A1A1A', lineHeight: 1.4, marginBottom: 36 } }, s.title || ''),
      // 본문
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 400, fontSize: 40, color: '#333333', lineHeight: 1.75 } }, s.body || ''),
    ),
  ); },
  quote: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: 60 } },
    ...
    h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      ...
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 48, color: '#1A1A1A', textAlign: 'center', lineHeight: 1.6, justifyContent: 'center' } }, s.body || ''),

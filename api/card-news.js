...
function lines(text, style) {
  ...
  if (parts.length <= 1) return h('div', { style }, text || '');
  return h('div', { style: { ...style, display: 'flex', flexDirection: 'column' } },
...
const layouts = {
  cover: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: _P } },
    ...
    lines(s.title, { fontFamily: _F, fontWeight: 700, fontSize: s.title && s.title.replace(/\n/g,'').length > 16 ? 80 : 96, color: '#FFFFFF', textAlign: 'center', lineHeight: 1.35, maxWidth: _W - _P * 2, justifyContent: 'center', alignItems: 'center' }),
    s.subtitle ? lines(s.subtitle, { fontFamily: _F, fontWeight: 400, fontSize: 36, color: t.accent, marginTop: 44, textAlign: 'center', lineHeight: 1.5, maxWidth: _W - _P * 2, justifyContent: 'center', alignItems: 'center' }) : null,
  ...
  content: (s, t) => { const num = s.number ? String(s.number).padStart(2, '0') : '01'; return h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.secondary, padding: 60 } },
    h('div', { style: { display: 'flex', flexDirection: 'column', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      h('div', { style: { display: 'flex', flexDirection: 'row', alignItems: 'center', marginBottom: 36 } },
  ...
  quote: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: 60 } },
    h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 160, color: t.accent, lineHeight: 0.6, marginBottom: 36 } }, '\u201C'),
      lines(s.body, { fontFamily: _F, fontWeight: 700, fontSize: 48, color: '#1A1A1A', textAlign: 'center', lineHeight: 1.6, justifyContent: 'center', alignItems: 'center' }),
      s.source ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 400, fontSize: 32, color: '#888888', marginTop: 44, textAlign: 'center', justifyContent: 'center' } }, s.source) : null,
    ),
  ),
  data: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.secondary, padding: 60 } },
    h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      s.label ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 34, color: '#888888', marginBottom: 28, letterSpacing: 2 } }, s.label) : null,
      h('div', { style: { display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', marginBottom: 20 } },
        h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 140, color: t.primary, lineHeight: 1 } }, s.value || '0'),
        s.unit ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 56, color: t.primary, marginLeft: 10, paddingBottom: 16 } }, s.unit) : null,
      ),
      h('div', { style: { display: 'flex', width: 80, height: 5, background: t.accent, borderRadius: 3, marginTop: 20, marginBottom: 36 } }),
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 400, fontSize: 40, color: '#333333', textAlign: 'center', lineHeight: 1.65, justifyContent: 'center' } }, s.body || ''),
    ),
  ),
  cta: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: _P } },
    lines(s.title, { fontFamily: _F, fontWeight: 700, fontSize: 64, color: '#FFFFFF', textAlign: 'center', lineHeight: 1.45, maxWidth: _W - _P * 2, justifyContent: 'center', alignItems: 'center', marginBottom: 48 }),
    ...
    s.body ? lines(s.body, { fontFamily: _F, fontWeight: 400, fontSize: 34, color: 'rgba(255,255,255,0.55)', textAlign: 'center', lineHeight: 1.6, maxWidth: _W - _P * 2, justifyContent: 'center', alignItems: 'center' }) : null,
  ),
};

...
const layouts = {
  ...
  quote: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: 60 } },
    h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      // 상단 가는 구분선
      h('div', { style: { display: 'flex', width: _W - 240, height: 1, background: `${t.accent}40`, marginBottom: 32 } }),
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 140, color: t.accent, lineHeight: 0.6, marginBottom: 32 } }, '\u201C'),
      ...
      s.source ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 400, fontSize: 28, color: '#999999', marginTop: 40, textAlign: 'center', justifyContent: 'center', letterSpacing: 1 } }, s.source) : null,
      // 하단 가는 구분선
      h('div', { style: { display: 'flex', width: _W - 240, height: 1, background: `${t.accent}40`, marginTop: 32 } }),
    ),
  ),
  data: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.secondary, padding: 60 } },
    h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: _W - 120, background: '#FFFFFF', borderRadius: t.radius + 8, padding: 72 } },
      s.label ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 28, color: '#999999', marginBottom: 24, letterSpacing: 3 } }, s.label) : null,
      h('div', { style: { display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', marginBottom: 16 } },
        h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 140, color: t.primary, lineHeight: 1 } }, s.value || '0'),
        s.unit ? h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 52, color: t.primary, marginLeft: 8, paddingBottom: 16 } }, s.unit) : null,
      ),
  ...
  cta: (s, t) => h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: _W, height: _H, background: t.bgDark, padding: _P } },
    // 배경 장식
    h('div', { style: { display: 'flex', position: 'absolute', top: -40, left: -40, width: 240, height: 240, background: t.accent, opacity: 0.06, borderRadius: 120 } }),
    ...
    s.buttonText ? h('div', { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', background: t.accent, borderRadius: t.radius + 4, padding: '24px 72px', marginBottom: 32 } },
      h('div', { style: { display: 'flex', fontFamily: _F, fontWeight: 700, fontSize: 36, color: t.bgDark, letterSpacing: 1 } }, s.buttonText),
    ) : null,
